...
@interface GodPostViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation GodPostViewController
...
- (NSMutableDictionary *)paras {
    if (!_paras) {
        ...
        _paras[LIMIT] = @20;
        _paras[OFFSET] = @100; //修改一下，获得以后的数据，其实还是和热帖同一个数据
        _paras[VER] = @"6.2";
    }
    return _paras;
}
